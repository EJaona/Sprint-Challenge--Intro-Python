...
c = [n.name for n in humans if n.name[0] == "A" or n.name[0] == "B" or n.name[0] == "C" or n.name[0] == "D" or n.name[0] == "E" or n.name[0] == "F" or n.name[0] == "G"]
print(c)
...
g = [f"{n.name.upper()} {n.age + 5}" for n in humans]
print(g)
